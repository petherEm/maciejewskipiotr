...
import avatarImage from '@/images/mecasual3.jpeg'
      ...
      >
        ...
        <nav className="mt-6">
          <ul className="-my-2 divide-y divide-zinc-100 text-base text-zinc-800 dark:divide-zinc-100/5 dark:text-zinc-300">
            ...
            {/* <MobileNavItemVaBank href="https://www.vabank.dev" target="_blank">
              vabank.dev
            </MobileNavItemVaBank> */}
          </ul>
        </nav>
  ...
  return (
    <li>
      ...
      >
        {children}
        {isActive && (
          <span className="absolute inset-x-1 -bottom-px h-px bg-gradient-to-r from-teal-500/0 via-teal-500/40 to-teal-500/0 dark:from-teal-400/0 dark:via-indigo-400/40 dark:to-teal-400/0" />
        )}
      </Link>
    </li>
  )
  ...
  return (
    <li>
      <Link
        ...
        target="_blank"
        className={clsx(
          'relative block px-3 py-2 text-red-500 transition dark:text-red-400',
          isActive
  ...
  return (
    <nav {...props}>
      <ul className="flex rounded-full bg-white/90 px-3 text-sm font-medium text-zinc-800 shadow-lg shadow-zinc-800/5 ring-1 ring-zinc-900/5 backdrop-blur dark:bg-zinc-800/90 dark:text-zinc-200 dark:ring-white/10">
        ...
        <NavItemExternal href="https://www.vabank.dev">
          vabank.dev
        </NavItemExternal>
      </ul>
    </nav>
